...
;	modified_frame = frame - byte(mininum_intensity_matrix)
	...
	medianofFrame_left = float(median(modified_frame(10:246, 10:502)))
	varianceofFrame_left = variance(modified_frame(10:246, 10:502))
	medianofFrame_right = float(median(modified_frame(266:502, 10:502)))
	varianceofFrame_right = variance(modified_frame(266:502, 10:502))
	...
	for j = 0, 2 do begin
		...
		case !MOUSE.BUTTON of
			1 : begin
					if point_x lt 256 then begin
						x_left(j) = point_x
						y_left(j) = point_y
						x_right(j) = point_x + 526
						y_right(j) = point_y
						endif else begin
							x_right(j) = point_x
							y_right(j) = point_y
